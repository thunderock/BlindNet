...
def get_bbox_dataloader(annoation_path, img_dir_path, config, train = True):
    dataset = MaskCocoDataset(annoation_path, img_dir_path, config)
...
def train_model(config):
    ...
    for epochs in range(config["epochs"]):
        ...
        val_loss = calc_val_loss(model, loss_fn, val_loader)
...
if __name__ == '__main__':
    config = {
        ...
        "train_annotation_path": "datasets/coco/annotations/instances_val2017.json",
        "train_img_dir_path": "datasets/coco/val2017/",
        "inp_img_size": 384,
        "inp_img_scale": 1.1,
        "target_img_size": 384,
        "total_categories": 91,
